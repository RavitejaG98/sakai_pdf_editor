...
import PDFComponent from '../../demo/components/PDFComponentMAC'
import PDFComponentSign from '../../demo/components/PDFComponentSign'
...
const TableDemo = () => {
    ...
    const activityBodyTemplate = (rowData) => {
        return <div>
            <Button icon="pi pi-comment" className="p-button-rounded" onClick={showDialog} id="markcomment" />
            <Tooltip target="#markcomment" content="Markup & Comment" position="top" />
            <Button icon="pi pi-pencil" className="p-button-rounded" onClick={showSignDialog} id="signpdf" />
            <Tooltip target="#signpdf" content="Sign" position="top" />
            <Button icon="pi pi-book" className="p-button-rounded " id="viewothers" />
            <Tooltip target="#viewothers" content="View others markup & commment" position="top" />
    ...
    return (
        <div className="grid">
            <div>
                <Dialog header="upload Signed Drawing" visible={visible} style={{ width: sign ?  '50vw' : '100vw' }} onHide={hideDialog}>
                    ...
                    {sign == false && <div style={{ backgroundColor: 'lightred', margin: 5, width: "90vw" }}>
                        <PDFComponent />
                    </div>}
                    {sign == true && <div style={{ backgroundColor: 'lightred', margin: 5, width: "90vw" }}>
                        <PDFComponentSign />
                    </div>}
                    {sign == false && <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '50vh' }}>
                    ...
                    <div>
                        ...
                        {sign == false && <div className='p-2 m-2' style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'flex-start' }}>
                            <Button
                                onClick={() => showToast('Signature Table has been finalised and drawing succesfully checked in')}
                                className="bg-blue-500 text-white p-2 rounded mx-20"
                            >
                            ...
                            <Button className="bg-blue-500 text-white p-2 rounded mx-20" label="Finalise Comments" />
                        </div>}
