            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="sno" header="Drawing ID" filter filterPlaceholder="Search by S.No" style={{ minWidth: '12rem' }} />
                        <Column header="Drawing Name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by drawing No"
                        field="drawingNo"
                        />
                        <Column
                            header="created by"
