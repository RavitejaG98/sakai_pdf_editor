...
import { CustomerService } from '../../demo/service/CustomerServiceReview';
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable
                        ...
                        header={header1}
                    >
                        <Column field="name" header="Drawing ID" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                        <Column header="Drawing Name" filterField="country.name" style={{ minWidth: '12rem' }} body={countryBodyTemplate} filter filterPlaceholder="Search by country" filterClear={filterClearTemplate} filterApply={filterApplyTemplate} />
                        <Column
                            header="created by"
                        ...
                        <Column field="Action" header="Action" dataType="boolean" bodyClassName="text-center" style={{ minWidth: '8rem' }} body={verifiedBodyTemplate} filter filterElement={verifiedFilterTemplate} />
                    </DataTable>
                </div>
            </div>
