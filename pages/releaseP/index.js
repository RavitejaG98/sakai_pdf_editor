...
import PDFComponent from '../../demo/components/PDFComponentRelease'
...
const TableDemo = () => {
    ...
    const activityBodyTemplate = (rowData) => {
        return <div>
            <Button icon="pi pi-verified" className="p-button-rounded" onClick={showDialog} severity='success' id="releaseDrawing" />
            <Tooltip target="#releaseDrawing" content="Release Drawing" position="top" />
            ...
            <Button icon="pi pi-undo" className="p-button-rounded" id="revertdrawing" severity='warning' />
            <Tooltip target="#revertdrawing" content="Revert Drawing" position="top" />
    ...
    return (
        <div className="grid">
            <div>
                <Dialog header="upload Signed Drawing" visible={visible} style={{ width: '50vw' }} onHide={hideDialog}>
                    ...
                    <div style={{ backgroundColor: 'lightred', margin: 5, width: "90vw" }}>
                        <PDFComponent />
                    </div>
